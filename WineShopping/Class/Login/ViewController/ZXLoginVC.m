...
@property(nonatomic,strong)ZXLoginViewModel    *viewModel;
...
- (void)initView
{
    ...
    [self.loginBtn setBackgroundImage:[UIImage imageFromColor:kRGBAColor(210, 210, 210, 1)] forState:UIControlStateDisabled];
    ...
    [self.codeBtn setBackgroundImage:[UIImage imageFromColor:kRGBAColor(210, 210, 210, 1)] forState:UIControlStateDisabled];
    ...
    self.voiceLabel.textColor               = kRGBAColor(70, 70, 70, 1);
    [self.voiceLabel setText:@"收不到验证码？使用语音验证" Font:[UIFont zxNormalFont:14] withColor:[UIColor blueColor] Range:NSMakeRange(9, 4)];
