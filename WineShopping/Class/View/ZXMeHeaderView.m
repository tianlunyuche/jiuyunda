...
- (void)configView
{
    ...
    _w_nickNameLabel.textColor    = kRGBAColor(252, 252, 252, 1);
    _w_nickNameLabel.font         = [UIFont zxNormalFont:16];
    ...
    _w_phoneNum.textColor       = kRGBAColor(252, 252, 252, 1);
    _w_phoneNum.font            = [UIFont zxNormalFont:16];
    ...
    bottomBG.backgroundColor    = kRGBAColor(70, 70, 70, 0.3);
    ...
    _w_collecLabel.textColor    = kRGBAColor(252, 252, 252, 1);
    _w_collecLabel.font         = [UIFont zxNormalFont:14];
    ...
    _w_historyLabel.textColor    = kRGBAColor(252, 252, 252, 1);
    _w_historyLabel.font         = [UIFont zxNormalFont:14];
    ...
    leftLabel.textColor         = kRGBAColor(252, 252, 252, 1);
    leftLabel.font              = [UIFont zxNormalFont:14];
    ...
    rightLabel.textColor        = kRGBAColor(252, 252, 252, 1);
    rightLabel.font             = [UIFont zxNormalFont:14];
