...
@implementation ZXOrderMenuView
...
- (void)configView
{
    ...
    [self.array enumerateObjectsUsingBlock:^(id  _Nonnull obj, NSUInteger idx, BOOL * _Nonnull stop) {
        ...
        [btn setTitleColor:kRGBAColor(252, 252, 252, 1) forState:UIControlStateNormal];
        ...
        line.tag                    = idx + 200;
        line.backgroundColor        = kRGBAColor(220, 220, 220, 0.8);
