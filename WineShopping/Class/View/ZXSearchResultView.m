...
@interface ZXSearchResultView ()<UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout,DZNEmptyDataSetSource>
...
@implementation ZXSearchResultView
...
- (void)configView
{
    ...
    _collectionView.backgroundColor = kRGBAColor(240, 240, 240, 1);
    [self.collectionView registerClass:[ZXHomeCell class] forCellWithReuseIdentifier:@"search"];
    ...
    _bageLabel.font                 = [UIFont zxNormalFont:12];
...
- (void)beginAnimation
{
    [UIView animateWithDuration:0.3
                     animations:^{
                         _bageLabel.font    = [UIFont zxNormalFont:14];
                     }
...
{
    ZXHomeCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:@"search" forIndexPath:indexPath];
    cell.isSearch = YES;
