...
@implementation ZXStarView

- (instancetype)initWithFrame:(CGRect)frame starSize:(CGSize)starSize withStyle:(ZXStarType)style
{
...
- (void)initView
{
    ...
    if (self.starType == ZXStarTypeInteger)
    {
        for (int i = 0; i < 5; i++)
        {
