//
//  ZXCategoryRightTableViewCell.m
//  WineShopping
//
...
@interface ZXCategoryRightTableViewCell ()
...
@implementation ZXCategoryRightTableViewCell
...
- (void)bind
{
    ...
    [self.managerView.addSubject subscribeNext:^(id x) {
        @strongify(self);
        [ZXTool beginAddAnimationWithImageView:self.w_imageView animationTime:0.55 startPoint:CGPointZero endPoint:CGPointZero];
    }];
}
...
- (void)configView
{
    ...
    _w_titleLabel.textColor     = kRGBAColor(70, 70, 70, 1);
    _w_titleLabel.font          = [UIFont zxNormalFont:14];
    ...
    _w_priceLabel.font          = [UIFont zxNormalFont:15];
    ...
    _w_specLabel.textColor      = kRGBAColor(150, 150, 150, 1);
    _w_specLabel.font           = [UIFont zxNormalFont:13];
    ...
    _w_stokeLabel.font          = [UIFont zxNormalFont:16];
