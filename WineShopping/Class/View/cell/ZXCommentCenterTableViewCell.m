//
//  ZXCommentCenterTableViewCell.m
//  WineShopping
//
...
@interface ZXCommentCenterTableViewCell ()
...
@property(nonatomic,strong)ZXOrderModel *w_order;

@end

@implementation ZXCommentCenterTableViewCell
...
- (void)updateWithOrder:(ZXOrderModel *)order
{
    ...
    {
        ZXOrderDetailModel *model = order.ordergoods.firstObject;
...
- (void)initView
{
    ...
    self.w_goodImg.layer.borderColor = kRGBAColor(222, 222, 222, 0.8).CGColor;
    ...
    _w_titleLabel.textColor = kRGBAColor(80, 80, 80, 1);
    _w_titleLabel.font      = [UIFont zxNormalFont:15];
    ...
    self.w_commentBtn.titleLabel.font   = [UIFont zxNormalFont:13];
    ...
    line.backgroundColor    = kRGBAColor(199, 199, 199, 1);
