...
///星级
@property(nonatomic,strong)ZXStarView      *w_starView;
...
{
    WS(weakSelf);
    self.backgroundColor        = kRGBAColor(253, 253, 253, 1);
    ...
    _w_nameLabel.textColor      = kRGBAColor(120, 120, 120, 1);
    _w_nameLabel.font           = [UIFont zxNormalFont:16];
    ...
    _w_commentTime.textColor    = kRGBAColor(100, 100, 100, 1);
    _w_commentTime.font         = [UIFont zxNormalFont:14];
    ...
    _w_starView                 = [[ZXStarView alloc]initWithFrame:CGRectMake(10, 70, 100, 20) starSize:CGSizeZero withStyle:ZXStarTypeInteger];
    ...
    bottomView.backgroundColor  = kRGBAColor(230, 230, 230, 1);
    ...
    _w_orderTime.font           = [UIFont zxNormalFont:14];
    ...
    _w_spec.font                = [UIFont zxNormalFont:14];
    ...
    _w_comment.textColor        = kRGBAColor(70, 70, 70, 1);
    _w_comment.font             = [UIFont zxNormalFont:16];
