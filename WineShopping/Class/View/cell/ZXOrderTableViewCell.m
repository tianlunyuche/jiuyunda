...
@interface ZXOrderTableViewCell ()

@property(nonatomic,strong)NSMutableArray *imageArray;

@end

@implementation ZXOrderTableViewCell
...
- (void)setGoodImage
{
    ...
    if (array.count == 1)
    {
        ZXOrderDetailModel *model              = array[0];
        if (self.imageArray.count <1)
        {
            ...
            imageView.layer.borderColor             = kRGBAColor(200, 200, 200, 1).CGColor;
        ...
        if (![_w_scrollView viewWithTag:100])
        {
            ...
            goodTitle.textColor                     = kRGBAColor(70, 70, 70, 1.0);
    ...
    else
    {
        ...
        for (int i = 0; i < array.count; i++)
        {
            ...
            ZXOrderDetailModel *model          = array[i];
