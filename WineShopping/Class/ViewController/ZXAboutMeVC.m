...
@interface ZXAboutMeVC ()<UITableViewDelegate,UITableViewDataSource,UIImagePickerControllerDelegate,UINavigationControllerDelegate>

@property(nonatomic,strong)ZXAboutMeViewModel  *viewModel;

@property(nonatomic,strong)NSArray              *titleArray;

@end

@implementation ZXAboutMeVC
@dynamic viewModel;
...
- (void)initView
{
    ...
    [self.tableView registerNib:[UINib nibWithNibName:@"ZXAboutMeTableViewCell" bundle:[NSBundle mainBundle]] forCellReuseIdentifier:@"cell"];
}
...
{
    ZXAboutMeTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"cell" forIndexPath:indexPath];
