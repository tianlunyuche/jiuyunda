...
@property(nonatomic,strong)ZXCategoryRightTableView    *rightTableView;
...
///筛选列表
@property(nonatomic,strong)ZXSiftView                  *siftView;
...
- (void)initView
{
    ...
    [self.leftTableView registerNib:[UINib nibWithNibName:@"ZXCategoryLeftTableViewCell" bundle:[NSBundle mainBundle]] forCellReuseIdentifier:@"cell"];
}
- (void)resetSiftView
{
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    ZXCategoryLeftTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"cell"];
...
- (ZXCategoryRightTableView *)rightTableView
{
    if (!_rightTableView)
    {
        _rightTableView = [[ZXCategoryRightTableView alloc]initWithFrame:CGRectMake(75, 0, kWidth - 75, kHeight - 49) style:UITableViewStylePlain];
...
- (ZXSiftView *)siftView
{
    if (!_siftView)
    {
        _siftView = [[ZXSiftView alloc]initWithFrame:CGRectMake(0, 0, kWidth, kHeight - 64 - 49)];
        _siftView.tag = 1111;
    }
    return _siftView;
}
