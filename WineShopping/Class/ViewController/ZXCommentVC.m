...
@interface ZXCommentVC ()

@property(nonatomic,strong)ZXCommentViewModel  *viewModel;

@property(nonatomic,strong)UIImageView          *goodImg;

@property(nonatomic,strong)ZXStarView          *starView;
...
- (void)bindViewModel
{
    ...
    self.starView.starBlock = ^(NSString *star){
        ...
        [self.starLabel setText:self.starLabel.text Font:[UIFont zxNormalFont:16] withColor:THEME_COLOR Range:NSMakeRange(3, star.length)];
    };
...
- (void)backBtnClick
{
    ...
    [action2 setValue:kRGBAColor(30, 30, 30, 1) forKey:@"titleTextColor"];
...
- (void)initView
{
    ...
    self.view.backgroundColor = kRGBAColor(250, 250, 250, 1);
    ...
    ZXOrderDetailModel *model = self.viewModel.order.ordergoods.firstObject;
    ...
    self.starLabel.textColor    = kRGBAColor(150, 150, 150, 1);
    self.starLabel.font         = [UIFont zxNormalFont:16];
    self.starLabel.text         = @"评分：5.0";
    [self.starLabel setText:self.starLabel.text Font:[UIFont zxNormalFont:16] withColor:THEME_COLOR Range:NSMakeRange(3, 3)];
    ...
    line.backgroundColor = kRGBAColor(222, 222, 222, 1);
    ...
    self.textView.font = [UIFont zxNormalFont:17];
    ...
    self.addBtn.titleLabel.font = [UIFont zxNormalFont:16];
    ...
    tipLabel.text = @"匿名评价";
    tipLabel.textColor = kRGBAColor(188, 188, 188, 1);
    ...
    self.commitBtn.titleLabel.font = [UIFont zxNormalFont:20];
...
- (ZXStarView *)starView
{
    if (!_starView)
    {
        _starView = [[ZXStarView alloc]initWithFrame:CGRectMake(80, 40, 220, 40) starSize:CGSizeZero withStyle:ZXStarTypeFloat];
    }
    return _starView;
}
- (UILabel *)starLabel
