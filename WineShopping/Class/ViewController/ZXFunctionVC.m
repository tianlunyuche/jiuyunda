...
#import "ZXFunctionVC.h"
#import "ZXFunctionViewModel.h"

@interface ZXFunctionVC ()<UITableViewDelegate,UITableViewDataSource>

@property(nonatomic,strong)ZXFunctionViewModel *viewModel;

@property(nonatomic,strong)UITableView *tableView;

@end

@implementation ZXFunctionVC
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (!cell)
    {
        ...
        cell.textLabel.textColor= kRGBAColor(70, 70, 70, 1);
