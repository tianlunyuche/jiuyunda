...
#import "ZXMapSearchTableView.h"

@interface ZXMapVC ()<UITableViewDelegate,UITableViewDataSource,BMKPoiSearchDelegate,BMKMapViewDelegate,BMKGeoCodeSearchDelegate,UISearchBarDelegate>
...
///搜索框tableView
@property(nonatomic,strong)ZXMapSearchTableView    *searchTableView;
...
- (void)resetNavi
{
    ...
    //    self.searchBar.tintColor        = kRGBAColor(70, 70, 70, 1);
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (!cell)
    {
        ...
        cell.textLabel.font = [UIFont zxNormalFont:14];
        cell.textLabel.textColor = kRGBAColor(80, 80, 80, 1);
        cell.detailTextLabel.textColor = kRGBAColor(120, 120, 120, 1);
    }
...
- (ZXMapSearchTableView *)searchTableView
{
    if (!_searchTableView)
    {
        _searchTableView = [[ZXMapSearchTableView alloc]initWithFrame:CGRectMake(0, 64, kWidth, kHeight - 64) style:UITableViewStylePlain];
