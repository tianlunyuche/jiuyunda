...
@interface ZXNewAddressVC ()<UITextFieldDelegate>

@property(nonatomic,strong)ZXNewAddressViewModel   *viewModel;
...
@property(nonatomic,strong)ZXSexView               *sexView;
...
- (void)initView
{
    ...
    topLabel.textColor                  = kRGBAColor(120, 120, 120, 1);
    topLabel.text                       = @"联 系 人";
    topLabel.font                       = [UIFont zxNormalFont:14];
    ...
    self.nameTXF.font                   = [UIFont zxNormalFont:14];
    ...
    line1.backgroundColor               = kRGBAColor(215, 215, 215, 1);
    ...
    midLabel.text                       = @"手机号码";
    midLabel.textColor                  = kRGBAColor(120, 120, 120, 1);
    midLabel.font                       = [UIFont zxNormalFont:14];
    ...
    self.phoneTXF.font                  = [UIFont zxNormalFont:14];
    ...
    bottomLabel.text                    = @"地址";
    bottomLabel.textColor               = kRGBAColor(120, 120, 120, 1);
    bottomLabel.font                    = [UIFont zxNormalFont:14];
    ...
    self.addressTXF.font                  = [UIFont zxNormalFont:14];
    self.addressTXF.placeholder           = @"请选择地址";
    self.addressTXF.text =@"这里";
    ...
    line2.backgroundColor               = kRGBAColor(215, 215, 215, 1);
    ...
    detail.text                     = @"详细地址";
    detail.textColor                = kRGBAColor(120, 120, 120, 1);
    detail.font                     = [UIFont zxNormalFont:14];
    ...
    self.detailTXF.font                 = [UIFont zxNormalFont:14];
    ...
    line3.backgroundColor               = kRGBAColor(215, 215, 215, 1);
    ...
    _saveBtn.titleLabel.font            = [UIFont zxNormalFont:20];
