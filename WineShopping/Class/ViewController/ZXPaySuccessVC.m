...
#import "ZXPaySuccessVC.h"
#import "ZXPaySuccessViewModel.h"
#import "ZXOrderModel.h"

@interface ZXPaySuccessVC ()

@property(nonatomic,strong)ZXPaySuccessViewModel       *viewModel;
///查看订单
...
- (void)initView
{
    ...
    tipLabel.font                   = [UIFont zxNormalFont:18];
    tipLabel.textColor              = kRGBAColor(70, 70, 70, 1);
    ...
    payType.font                    = [UIFont zxNormalFont:15];
    payType.textAlignment           = NSTextAlignmentRight;
    payType.textColor               = kRGBAColor(150, 150, 150, 1);
    ...
    priceLabel.font                 = [UIFont zxNormalFont:15];
    ...
    self.orderBtn.titleLabel.font   = [UIFont zxNormalFont:17];
    _orderBtn.layer.cornerRadius    = 5;
    _orderBtn.layer.masksToBounds   = YES;
    _orderBtn.layer.borderColor     = kRGBAColor(198, 198, 198, 1).CGColor;
    _orderBtn.layer.borderWidth     = 0.3;
    [_orderBtn setTitle:@"查看订单" forState:UIControlStateNormal];
    [_orderBtn setTitleColor:kRGBAColor(200, 200, 200, 1) forState:UIControlStateNormal];
    ...
    self.goHomeBtn.titleLabel.font  = [UIFont zxNormalFont:17];
    _goHomeBtn.layer.cornerRadius   = 5;
    _goHomeBtn.layer.masksToBounds  = YES;
    _goHomeBtn.layer.borderColor    = kRGBAColor(198, 198, 198, 1).CGColor;
    _goHomeBtn.layer.borderWidth    = 0.3;
    [_goHomeBtn setTitle:@"回首页" forState:UIControlStateNormal];
    [_goHomeBtn setTitleColor:kRGBAColor(200, 200, 200, 1) forState:UIControlStateNormal];
