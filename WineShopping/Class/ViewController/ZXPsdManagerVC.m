...
#import "ZXPsdManagerVC.h"
#import "ZXPsdManagerViewModel.h"

@interface ZXPsdManagerVC ()<UITextFieldDelegate>

@property(nonatomic,strong)ZXPsdManagerViewModel   *viewModel;
/**原密码*/
...
- (void)initView
{
    ...
    self.confirmBtn.titleLabel.font         = [UIFont zxNormalFont:18];
    ...
    [self.confirmBtn setBackgroundImage:[UIImage imageFromColor:kRGBAColor(210, 210, 210, 1)] forState:UIControlStateDisabled];
...
- (UITextField *)w_originTextField
{
    if (!_w_originTextField)
    {
        ...
        view.backgroundColor        = kRGBAColor(252, 252, 252, 1);
        ...
        _w_originTextField.font             = [UIFont zxNormalFont:16];
...
- (UITextField *)w_newTextField
{
    if (!_w_newTextField)
    {
        ...
        _w_newTextField.font                = [UIFont zxNormalFont:16];
...
- (UITextField *)w_confirmTextField
{
    if (!_w_confirmTextField)
    {
        ...
        _w_confirmTextField.font            = [UIFont zxNormalFont:16];
