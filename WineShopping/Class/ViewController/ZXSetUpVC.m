...
@interface ZXSetUpVC ()<UITableViewDelegate,UITableViewDataSource>

@property(nonatomic,strong)ZXSetupViewModel    *viewModel;
...
- (void)initView
{
    ...
    [self.tableView registerNib:[UINib nibWithNibName:@"ZXSetupTableViewCell" bundle:[NSBundle mainBundle]] forCellReuseIdentifier:@"cell"];
...
{
    ZXSetupTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"cell" forIndexPath:indexPath];
    NSArray *array  = @[[ZXTool getCacheSize],@"",[ZXTool getVersion],@"",@""];
...
- (UIButton *)exitBtn
{
    if (!_exitBtn)
    {
        ...
        _exitBtn.backgroundColor        = kRGBAColor(253, 253, 253, 1);
    }
    return _exitBtn;
}
