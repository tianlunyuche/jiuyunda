...
@interface ZXAboutMeViewModel ()<UIImagePickerControllerDelegate,UINavigationControllerDelegate>
///昵称
@property(nonatomic,strong)UITextField *textField;

@end

@implementation ZXAboutMeViewModel
...
- (void)initViewModel
{
    ...
    self.cellClickCommand   = [[RACCommand alloc]initWithSignalBlock:^RACSignal *(id input) {
        ...
        if (indexPath.section == 0)
        {
            switch (indexPath.row)
            {
                case 0:
                {
                    ...
                    [action1 setValue:kRGBAColor(30, 30, 30, 1) forKey:@"titleTextColor"];
                    [action2 setValue:kRGBAColor(30, 30, 30, 1) forKey:@"titleTextColor"];
                    [action3 setValue:kRGBAColor(80, 80, 80, 1) forKey:@"titleTextColor"];
                ...
                case 1:
                {
                    ...
                    [action1 setValue:kRGBAColor(122, 230, 90, 1) forKey:@"titleTextColor"];
                    [action2 setValue:kRGBAColor(150, 150, 150, 1) forKey:@"titleTextColor"];
                ...
                case 2:
                {
                    ...
                    [action1 setValue:kRGBAColor(80, 80, 80, 1) forKey:@"titleTextColor"];
                    [action2 setValue:kRGBAColor(80, 80, 80, 1) forKey:@"titleTextColor"];
        ...
        {
            ZXLog(@"address");
            ZXAddressManagerViewModel *viewModel = [[ZXAddressManagerViewModel alloc]initWithService:self.services params:@{@"title":@"地址管理"}];
